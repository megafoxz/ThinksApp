import { ApplicationCookieTokenIDName, ApplicationLocalStorageUserDataName } from './setting';
...
export const UserTypeOptions = Object.keys(UserTypeCodes).map(key => ({ text: key, value: UserTypeCodes[key] }));
